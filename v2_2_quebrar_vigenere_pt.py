tamanho_tentativa = 10
alfabeto = 'abcdefghijklmnopqrstuvwxyz'

# frequencias
frequencia_pt = [0.1463, 0.0104, 0.0388, 0.0499, 0.1257, 0.0102, 0.0130, 0.0128, 0.0618,
...
def contar_frequencia(sequence):
	...
	for i in range(26):
		...
		for j in range(26):
			soma_chi_quadrado+=((v[j] - float(frequencia_pt[j]))**2)/float(frequencia_pt[j])
...
def main():
	...
	texto_cifrado_bruto = Path('desafio2.txt').read_text()
	print(texto_cifrado_bruto)
